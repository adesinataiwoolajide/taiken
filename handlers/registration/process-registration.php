		...
		if(isset($_POST['register'])){
			...
			if($password != $repeat){
				...
				if(!empty($register->newUserRegistration($full_name, $user_name, $password, $reg_number))){
					...
					$_SESSION['success'] = "You Have Completed Your Registration Successfully, Please Login With Your Details";
					$all_purpose->redirect("../../login.php");
				}else{
					$_SESSION['error'] = "Unable to Complete Your Registration at the momnet, Please Try Again Later";
					$all_purpose->redirect("../../register.php");
				}
			}
