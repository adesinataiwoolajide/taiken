<?php
    ...
    $seeProdcut = $register->gettingCompared($reg_number);
?>
<main class="main">
    ...
    <nav aria-label="breadcrumb" class="breadcrumb-nav">
        <div class="container">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" class="active"><a href="my-comparedlist.php"><i class="icon-mode-grid"></i>My Compared List</a></li>
                
        <li class="breadcrumb-item active" aria-current="page">My Compared List Products</li>
            </ol>
        </div><!-- End .container -->
    </nav>
    <?php
    if($register->checkCompared($reg_number)){ ?>
        <div class="col-md-12">
            <p style="color: red" align="center"><?php echo $_SESSION['name']." Your Compared is Empty" ?></p>
        </div><?php
    }else{ ?>
