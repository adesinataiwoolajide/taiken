	...
	try{
		...
		if($file_size > 2097152){
			...
			if(isset($_POST['adding-product'])){
				...
				if(!empty($productDetails->addNewProduct($product_thumbnail, $product_number, $product_description, $product_price, $publish, $type_id, $quantity, $product_size, $category_id))){
