            ...
            <div class="row">
                <div class="col-md-12"><?php 
                    if($totalItems > 1){
                        if($page != $totalPages){ ?>
                            <div align="left">
                                <a href="merchant-products-list.php?merchant_number=<?php echo $merchant_number ?>&&page=<?php echo $page + 1;?>" class="btn btn-primary">NEXT PAGE
                                </a>
                            </div><?php
                        } 
                        if($page != 1){ ?>
                            <div align="right" style="margin-top: -30px">
                                <a href="merchant-products-list.php?merchant_number=<?php echo $merchant_number ?>&&page=<?php echo $page - 1;?>" class="btn btn-success">PREVIOUS PAGE
